...
export const EMP_PAGES = [
  {
    ...
    fields: [
      ...
      { key: "업무스타일", q: "업무 스타일", type: "chip", opts: ["전일 출근", "재택 근무", "혼합형"] },
    ],
  },
  {
    title: "웰니스 문제 인식",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "월지불금액", q: "월 지불 가능 금액", type: "chip", opts: ["1만원 미만", "1만원~3만원", "3만원~5만원", "5만원 이상", "가격에 따라 결정"] },
    ],
  },
  {
    title: "기업 관점 수용성",
...
export const MGR_PAGES = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "필요기능", q: "필요한 기능 (복수 선택)", type: "multi", opts: ["정신건강 콘텐츠", "요가/필라테스", "번아웃 평가 및 리포트", "분석 대시보드", "기타"] },
      { key: "저렴의심가격", q: "전문성이 의심될 정도로 저렴한 비용은?", type: "chip", opts: ["인당 5천원~1만원", "인당 1만원~2만원", "인당 2만원~3만원"] },
