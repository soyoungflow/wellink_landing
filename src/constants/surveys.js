...
export const MGR_PAGES = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "필요서비스", q: "성과 향상과 복지를 위해 가장 필요한 서비스가 무엇이라고 생각하시나요?", type: "textarea" },
      { key: "애로사항", q: "직원 복지 서비스 개선의 애로 사항이 있다면, 무엇인가요?", type: "textarea", placeholder: "예산 부족, 운영 인력 부족 등" },
    ],
  },
  {
    title: "서비스 도입 의향",
    ...
    fields: [
      ...
      { key: "필요기능", q: "제공 되길 원하는 서비스 기능이 무엇인가요?(복수 선택)", type: "multi", opts: ["정신 건강 콘텐츠", "요가, 필라테스 등 운동 콘텐츠", "번아웃 평가 및 리포트", "데이터 분석 및 대시보드", "기타"] },
      { key: "저렴의심가격", q: "전문성이 의심될 정도로 저렴한 서비스 비용은 어느 정도인가요??", type: "chip", opts: ["인당 5천원 ~1만원", "인당 1~2만원", "인당 2~3만원"] },
      { key: "합리적가격", q: "가장 합리적인 서비스 비용은 어느 정도 인가요?", type: "textarea", placeholder: "인당/월, 연 구독, 계약건당 등 자유롭게" },
    ],
  },
  {
    title: "추가 의견",
