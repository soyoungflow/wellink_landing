...
const VALUE_ITEMS = [
  ...
  { num: "02", title: "맞춤 프로그램으로 실질적 개선을", desc: "WCWI 결과에 따라 필라테스, 명상, 스트레칭 등 개인별·팀별 최적화된 웰니스 콘텐츠를 추천합니다.", color: "#9B7EC8" },
...
const FAQ_ITEMS = [
  ...
  { q: "어떤 규모의 기업이 사용할 수 있나요?", a: "직원 10명의 소규모 팀부터 200명 이상의 기업까지 모두 적합합니다." },
